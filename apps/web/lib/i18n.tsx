...
export const COPY = {
  es: {
    ...
    w_lab: 'Quién soy', w_h: 'Soy Iris. Le pongo nombre a lo que se repite.',
    w_p1: 'Años en grandes empresas viendo cómo se comporta la gente cuando nadie mira.',
    w_p2: 'Junté lo que funcionaba de cada cosa que estudié y en 2010 abrí consulta. Desde entonces busco lo mismo: que salgas sabiendo qué te toca hacer a ti.',
    ...
    wl_ph_mail: 'tucorreo@ejemplo.com', wl_cta: 'Guardar mi precio de {p}', wl_cta_pago: 'Reservar mi plaza por {p}',
    ...
    ch_cond: 'Antes del último paso, una cosa: si te surge algo puedes cambiar el día, avisándome con 24 horas de antelación. Con menos de 24 horas ya no le puedo dar esa hora a nadie, así que se da por dada.',
  ...
  pt: {
    ...
    w_lab: 'Quem sou', w_h: 'Sou a Iris. Ponho nome ao que se repete.',
    w_p1: 'Anos em grandes empresas a ver como as pessoas se comportam quando ninguém olha.',
    w_p2: 'Juntei o que funcionava de cada coisa que estudei e em 2010 abri consulta. Desde então procuro o mesmo: que saias a saber o que te toca fazer a ti.',
    ...
    wl_ph_mail: 'teuemail@exemplo.com', wl_cta: 'Guardar o meu preço de {p}', wl_cta_pago: 'Reservar a minha vaga por {p}',
    ...
    ch_cond: 'Antes do último passo, uma coisa: se te surgir alguma coisa podes mudar o dia, avisando-me com 24 horas de antecedência. Com menos de 24 horas já não posso dar essa hora a ninguém, por isso conta como dada.',
  ...
  en: {
    ...
    w_lab: 'Who I am', w_h: 'I am Iris. I put a name to what keeps repeating.',
    w_p1: 'Years in large companies watching how people behave when nobody is looking.',
    w_p2: 'I kept what worked from everything I studied and opened my practice in 2010. Ever since, I have been after the same thing: that you leave knowing what is yours to do.',
    ...
    wl_ph_mail: 'you@example.com', wl_cta: 'Lock in my {p} price', wl_cta_pago: 'Book my place for {p}',
