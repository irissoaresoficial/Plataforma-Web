...
export const COPY = {
  es: {
    ...
    ch_a1_kabala: 'Hola. Soy el agente de Iris. Vas a reservar la consulta de Kábala, que son {p}. Mi único trabajo es buscarte un hueco con ella. ¿Cómo te llamas?',
  ...
  pt: {
    ...
    ch_a1_kabala: 'Olá. Sou o agente da Iris. Vais marcar a consulta de Cabala, que são {p}. A minha única função é arranjar-te um horário com ela. Como te chamas?',
  ...
  en: {
    ...
    ch_a1_kabala: "Hi. I'm Iris's agent. You're booking the Kabbalah session, which is {p}. My only job is to find you a slot with her. What's your name?",
