      ...
      <div style={{ maxWidth: 1240, margin: '0 auto', display: 'flex', flexDirection: 'column', gap: 'clamp(26px,3.2vw,44px)' }}>
        ...
        >
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
            ...
            <span style={{ fontSize: 'clamp(30px,4.4vw,64px)', fontFamily: 'var(--serif)', lineHeight: 0.98, letterSpacing: '-.045em', maxWidth: '15ch', textWrap: 'pretty' }}>
              <T v={curso.titulo} />
            </span>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 'clamp(16px,2.4vw,38px)', justifySelf: 'end' }}>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
              <span style={{ fontSize: 'clamp(20px,2.2vw,30px)', fontFamily: 'var(--serif)', letterSpacing: '-.04em', lineHeight: 1 }}>
                <T v={curso.duracion} />
              </span>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
              <span style={{ fontSize: 'clamp(20px,2.2vw,30px)', fontFamily: 'var(--serif)', letterSpacing: '-.04em', lineHeight: 1, color: acento }}>
            ...
            >
              ...
              {curso.bloques.map((b, i) => (
                <div key={i} style={{ display: 'flex', gap: 12, alignItems: 'baseline' }}>
                  <span style={{ fontSize: 20, fontWeight: 900, letterSpacing: '-.04em', color: claro ? 'rgba(10,10,12,.16)' : 'rgba(244,243,239,.18)', width: 26, flexShrink: 0 }}>
    ...
    <div style={{ width: '100%', background: '#0A0A0C', color: '#F4F3EF', overflowX: 'hidden' }}>
      ...
      <div style={{ position: 'relative', padding: 'clamp(104px,16vh,170px) clamp(14px,3vw,36px) clamp(40px,5vw,70px)', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative', zIndex: 3, maxWidth: 1240, margin: '0 auto', display: 'flex', flexDirection: 'column', gap: 'clamp(22px,2.8vw,36px)' }}>
          ...
          <Reveal as="h1" delay={70} style={{ margin: 0, fontSize: 'clamp(38px,6.2vw,88px)', fontFamily: 'var(--serif)', lineHeight: 0.96, letterSpacing: '-.05em', maxWidth: '16ch', textWrap: 'pretty' }}>
        ...
        <div style={{ maxWidth: 1240, margin: '0 auto', display: 'flex', flexDirection: 'column', gap: 24 }}>
          ...
          >
            <div style={{ display: 'flex', flexDirection: 'column', gap: 7 }}>
              <span style={{ fontSize: 'clamp(20px,2.4vw,30px)', fontFamily: 'var(--serif)', letterSpacing: '-.035em', lineHeight: 1.05, maxWidth: '22ch' }}>
